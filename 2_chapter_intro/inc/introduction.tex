...
\subgraphpngint{fig:loschmidt}{dummy.png}{0.9}%
\end{minipage}%
\begin{minipage}[t]{.5\textwidth}
\subgraphpngint{fig:tol}{dummy.png}{0.3}\\[.2cm]
\subgraphpngint{fig:kekule}{dummy.png}{0.9}%
\end{minipage}\\[.2cm]
\subgraphpngint{fig:hofmann}{dummy.png}{0.245}%
\hfill
\subgraphpngint{fig:kendrew}{dummy.png}{0.5}
