...
\chapter[Ensembler: A Simple Package for Fast Prototyping and Teaching Molecular Simulations]{Ensembler: A Simple Package for Fast Prototyping and Teaching Molecular Simulations
    ...
    J. Chem. Inf. Model. 61 (2021) 560--564 , with permission from the American Chemical Society.}
}
...
The code of Ensembler is freely available on GitHub \url{https://github.com/rinikerlab/Ensembler} and can be directly explored with Binder\cite{Binder2018} or Colab\cite{Bisong2019}.
%
\end{summary}
...
\input{3_chapter_1/inc/implementation.tex}
