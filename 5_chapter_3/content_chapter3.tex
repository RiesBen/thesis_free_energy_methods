...
\chapter[Path-Free Multistate Methodology for Free Energy Calculations]{Relative Free-Energy Calculations for Scaffold Hopping-Type Transformations with an Automated RE-EDS Sampling Procedure 
    \footnote{\label{footnoteChapter2CopyRight} 
    Reprinted (adapted) from  Benjamin Ries, Karl Normak, R. Gregor Wei{\ss}, et al., 
    JCAMD, textbf{X}, XX-XX (202X) licensed by Creative Commons CC BY}
}
\chaptermark{FE: Multistate Method Development}
\label{ch:fereeds}
